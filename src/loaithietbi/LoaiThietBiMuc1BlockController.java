 ...
 */
public class LoaiThietBiMuc1BlockController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public LoaiThietBiMuc1BlockController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect(request.getContextPath()+"/loaithietbimuc1-danhsach?block="+block);
			return;
		}catch(Exception e) {
